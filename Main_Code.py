...
import matplotlib.pyplot as plt
import lidar 
file = 'C:/Users/bbshe/OneDrive - purdue.edu/Desktop/School/School Work/Spring 2021/EPICS121/prot 4/Copy of USGS_LPC_SD_NRCS_Fugro_B2_2017_13TFK240260_LAS_2019.laz'
lidar.myFunc(file)
...
app.layout = html.Div(style={'backgroundColor': colors['backstage']}, children = [
    dcc.Tabs(id='tabs-example', value='tab-1', children=[
       ...
       dcc.Tab(label = 'Map', value= 'tab-7', style =tab_style , selected_style = tab_selected_style),
...
image_filename = r'C:/Users/bbshe/OneDrive - purdue.edu/Desktop/School/School Work/Spring 2021/EPICS121/Prototype 3/Assets/Districtmap3.png'
...
def TabsFunction(tab):
    if tab == 'tab-7':
        ...
        return html.Details([
            html.Div([
    html.Img(src=app.get_asset_url('Districtmap3.png'))
    ]),
        html.Div([
